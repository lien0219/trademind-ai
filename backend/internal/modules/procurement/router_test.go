...
func TestRegisterExposesPurchaseOrderWorkflowRoutes(t *testing.T) {
	...
	want := map[string]bool{
		...
		"GET /api/v1/purchase-orders/:id/returnable-receipt-items": false,
		"GET /api/v1/purchase-returns":                             false,
		"POST /api/v1/purchase-returns":                            false,
		"GET /api/v1/purchase-returns/:id":                         false,
		"POST /api/v1/purchase-returns/:id/submit":                 false,
		"POST /api/v1/purchase-returns/:id/approve":                false,
		"POST /api/v1/purchase-returns/:id/complete":               false,
		"POST /api/v1/purchase-returns/:id/cancel":                 false,
	}
