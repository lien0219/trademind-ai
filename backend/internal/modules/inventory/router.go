...
func Register(g *gin.RouterGroup, h *Handler) {
	...
	g.GET("/inventory/warehouse-placements", h.ListWarehouseSKUPlacements)
	g.POST("/inventory/warehouse-placements", h.CreateWarehouseSKUPlacement)
	g.PUT("/inventory/warehouse-placements/:id", h.UpdateWarehouseSKUPlacement)
