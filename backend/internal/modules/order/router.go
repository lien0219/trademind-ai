...
func Register(g *gin.RouterGroup, h *Handler) {
	...
	w.GET("/:id/orders/:orderId/freight-quotes", h.GetFulfillmentWaveFreightQuotes)
	w.POST("/:id/orders/:orderId/freight-quotes/confirm", h.PostFulfillmentWaveFreightQuote)
