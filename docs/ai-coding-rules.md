...
| 新增或修改环境变量 | `.env.example`、`.env.docker.example`、`docs/development.md`、`docs/docker-deployment.md` |
| 新增 API 或改变 API 契约 | 相关 `docs/` 文档、前端 `services`、README 中的能力描述 |
| 新增 Provider | `docs/provider.md`、README 功能表、设置页面说明、示例配置 |
