...
- Manual fulfillment allocation with whole-order, single-warehouse candidates and an atomic confirm-and-reserve transaction that fails closed on stale revisions, insufficient availability, or ledger projection mismatches.
