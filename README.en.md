...
- Read-only order profit estimates combining order revenue, current supplier catalog cost, confirmed local freight, and succeeded refunds, while keeping known contribution separate and leaving missing platform, advertising, and warehouse fees unfilled. Current supplier prices are not presented as historical COGS.
