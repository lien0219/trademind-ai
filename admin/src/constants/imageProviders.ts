...
> = {
  ...
  removebg_api_key: { label: 'remove.bg 接口密钥', encrypted: true, extra: '请到 remove.bg 控制台申请' },
  openai_image_base_url: {
    label: 'OpenAI 图片接口地址',
    placeholder: 'https://api.openai.com/v1',
    extra: '留空则使用 OpenAI 官方地址；可用兼容代理',
  },
  openai_image_api_key: { label: 'OpenAI Image 接口密钥', encrypted: true, extra: '请到 OpenAI 或代理服务商控制台申请' },
  ...
  comfyui_api_key: { label: 'ComfyUI 接口密钥（可选）', encrypted: true },
  comfyui_workflow_json: {
  ...
  dashscope_image_api_key: { label: '通义万相 接口密钥', encrypted: true, extra: '请到阿里云百炼控制台申请' },
  ...
  volcengine_image_api_key: { label: '火山方舟 接口密钥', encrypted: true, extra: '请到火山引擎控制台申请' },
  volcengine_image_model: { label: '火山方舟模型接入点 ID', placeholder: 'doubao-seedream-3-0-t2i' },
  volcengine_image_size: { label: '火山方舟尺寸', placeholder: '1024x1024' },
  siliconflow_image_base_url: {
    label: '硅基流动接口地址',
    placeholder: 'https://api.siliconflow.cn/v1',
  },
  siliconflow_image_api_key: { label: '硅基流动 接口密钥', encrypted: true, extra: '请到硅基流动控制台申请' },
  ...
  hunyuan_image_api_key: { label: '腾讯混元 接口密钥（预留）', encrypted: true },
  hunyuan_image_model: { label: '腾讯混元模型（预留）' },
  timeout_sec: { label: '通用图片任务超时（秒）' },
  ocr_provider: { label: 'OCR 服务', placeholder: 'paddleocr', extra: '可用: ai_vision / paddleocr / aliyun / tencent' },
  ocr_base_url: { label: 'OCR 服务地址', placeholder: 'http://127.0.0.1:xxxx', extra: '本地 PaddleOCR 必填，需填写后端可访问的服务地址' },
  ocr_api_key: { label: 'OCR 接口密钥', encrypted: true, extra: '云端 OCR 服务需要填写' },
  ocr_secret: { label: 'OCR 密钥', encrypted: true, extra: '云端 OCR 服务需要填写' },
  ocr_paddleocr_service_url: { label: 'PaddleOCR 服务地址', placeholder: 'http://127.0.0.1:3101', extra: '本地 PaddleOCR 必填，需填写后端可访问的服务地址' },
  ocr_aliyun_endpoint: { label: '阿里云 OCR 接口地址', placeholder: 'ocr-api.cn-hangzhou.aliyuncs.com' },
  ocr_aliyun_region: { label: '阿里云 OCR 区域', placeholder: 'cn-hangzhou' },
  ocr_aliyun_api_name: { label: '阿里云 OCR 接口类型', placeholder: 'RecognizeGeneral' },
  ocr_aliyun_access_key_id: { label: '阿里云访问密钥 ID', encrypted: true },
  ocr_aliyun_access_key_secret: { label: '阿里云访问密钥', encrypted: true },
  ocr_tencent_endpoint: { label: '腾讯云 OCR 接口地址', placeholder: 'ocr.tencentcloudapi.com' },
  ocr_tencent_region: { label: '腾讯云 OCR 区域', placeholder: 'ap-guangzhou' },
  ocr_tencent_api_name: { label: '腾讯云 OCR 接口类型', placeholder: 'GeneralBasicOCR' },
  ocr_tencent_secret_id: { label: '腾讯云密钥 ID', encrypted: true },
  ocr_tencent_secret_key: { label: '腾讯云密钥', encrypted: true },
  ocr_timeout_sec: { label: 'OCR 超时（秒）', placeholder: '30' },
  ocr_min_confidence: { label: 'OCR 最低置信度', placeholder: '0.75', extra: '低于此置信度的文字将被忽略' },
  ocr_fallback_to_vision: { label: '失败自动降级到 AI 视觉 OCR（高级实验，不用于生产）', placeholder: 'false' },
  ocr_batch_concurrency: { label: '单次批量并发', placeholder: '1' },
  ocr_request_interval_ms: { label: 'OCR 请求间隔（毫秒）', placeholder: '500' },
  ocr_max_retries: { label: 'OCR 最大重试次数', placeholder: '1' },
  ...
  ai_inpaint_comfyui_image_node_id: { label: '局部擦除原图节点 ID' },
  ai_inpaint_comfyui_mask_node_id: { label: '局部擦除遮罩节点 ID' },
  ai_inpaint_comfyui_output_node_id: { label: '局部擦除输出节点 ID' },
};
