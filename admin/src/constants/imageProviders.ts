...
> = {
  ...
  ocr_provider: { label: 'OCR 服务', placeholder: 'paddleocr', extra: '可用: ai_vision / paddleocr / baidu / aliyun / tencent' },
  ocr_base_url: { label: 'OCR 服务地址', placeholder: 'http://127.0.0.1:xxxx', extra: '本地部署的 PaddleOCR 需要填写' },
