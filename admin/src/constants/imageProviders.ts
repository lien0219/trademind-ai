...
> = {
  ...
  ocr_api_key: { label: 'OCR API Key', encrypted: true, extra: '云端 OCR 服务需要填写' },
  ocr_secret: { label: 'OCR Secret', encrypted: true, extra: '云端 OCR 服务需要填写' },
  ocr_paddleocr_service_url: { label: 'PaddleOCR 服务地址', placeholder: 'http://127.0.0.1:3101', extra: '本地 PaddleOCR 必填，需填写后端可访问的服务地址' },
  ocr_aliyun_endpoint: { label: '阿里云 OCR Endpoint', placeholder: 'ocr-api.cn-hangzhou.aliyuncs.com' },
  ocr_aliyun_region: { label: '阿里云 OCR Region', placeholder: 'cn-hangzhou' },
  ocr_aliyun_api_name: { label: '阿里云 OCR 接口类型', placeholder: 'RecognizeGeneral' },
  ocr_aliyun_access_key_id: { label: '阿里云 AccessKeyId', encrypted: true },
  ocr_aliyun_access_key_secret: { label: '阿里云 AccessKeySecret', encrypted: true },
  ocr_tencent_endpoint: { label: '腾讯云 OCR Endpoint', placeholder: 'ocr.tencentcloudapi.com' },
  ocr_tencent_region: { label: '腾讯云 OCR Region', placeholder: 'ap-guangzhou' },
  ocr_tencent_api_name: { label: '腾讯云 OCR 接口类型', placeholder: 'GeneralBasicOCR' },
  ocr_tencent_secret_id: { label: '腾讯云 SecretId', encrypted: true },
  ocr_tencent_secret_key: { label: '腾讯云 SecretKey', encrypted: true },
