...
| 商品草稿 | 统一草稿模型、商品、SKU、图片、库存阈值、采集 warning、运营进度、发布前检查 | 已支持 |
| AI 标题优化 | OpenAI-compatible Provider、Prompt 模板、任务记录、结果对比、人工应用与安全撤销 | 已支持 |
| AI 描述生成 | 商品描述生成、Prompt 模板、AI 任务追踪、结果对比、人工应用与安全撤销 | 已支持 |
...
├── 商品草稿：标题、描述、SKU、图片、库存阈值、采集 warning、运营进度与下一步引导
├── AI 文本：标题优化、描述生成、Prompt 模板、调用记录、对比应用与撤销
